...
export default function FeaturedProject({ project, reverse }) {
  return (
    ...
    >
      <Link to={`/projects/${project.id}`} className="block overflow-hidden rounded-2xl border border-white/10 bg-bg-surface">
        <img
          src={project.image}
      ...
      <div>
        <span className="font-mono text-xs uppercase tracking-[0.2em] text-violet-400">Featured Project</span>
        <h3 className="mt-2 font-display text-2xl font-bold text-ink-100">{project.title}</h3>
